    ...
    try {
      ...
      if (!result.success) {
        if (result.code === "UNVERIFIED") {
          console.log("User unverified, redirecting to profile...")
          ...
          // Force immediate redirect as requested
          router.push("/profile")
        } else {
        ...
        <CardContent className="p-4 flex-1">
          <div className="flex flex-col gap-1 mb-3">
            ...
            <div className="flex items-center gap-1 text-xs text-muted-foreground">
              <Link href={`/profile/${listing.userId}`} className="hover:underline hover:text-primary z-10">
